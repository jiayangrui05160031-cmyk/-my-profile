(() => {
  ...
  const assetNotes = {
    ...
    'trophy-team': makeImageNote('assets/real-lpl.png', 'BLG：把 LPL 奖杯举起来', '粉白队服、金色奖杯和落下来的彩带；画面里的队标是 BLG。', '这张不能再被写成模糊的“某支队伍庆祝”。它记录的是 BLG 的 LPL 冠军时刻，属于国内联赛赛场，不该被偷懒地混成一张泛用的世界赛夺冠图。', 'LPL 的世界赛冠军脉络也值得讲清：IG 在 2018 年拿到第一座，FPX 在 2019 年接上，EDG 在 2021 年再一次举起召唤师杯。BLG 的这座奖杯有自己的舞台和意义。', '一座奖杯要有自己的赛场、年份和队名，庆祝才不会只剩一个模板。'),
    ...
    'ig-skins': makeImageNote('assets/英雄联盟.png', 'IG 2018：第一座世界冠军留下的皮肤', '这不是一张泛泛的竞技海报，而是 IG 2018 世界冠军限定皮肤：五位选手的签名和角色被留在同一张画面里。', '冠军皮肤有点像电子竞技里最具体的纪念碑。比赛结束很久以后，TheShy、Ning、Rookie、JackeyLove、Baolan 仍然会以角色、特效和签名的方式，继续出现在一局又一局游戏里。', '所以它不只是“赢过一次”的宣传图，而是 LPL 第一座世界冠军被做成了可以被玩家打开、选择、操作的记忆。', '有些冠军会进入奖杯柜；有些冠军会继续出现在峡谷里。'),
    'edg-worlds': makeImageNote('assets/英雄联盟2.png', 'EDG 2021：五局之后，召唤师杯归来', '银色奖杯、蓝色彩带和队服上的 EDG 标记都很清楚：这是 2021 世界赛夺冠现场。', '它以前被写成“大家一起捧杯”，太偷懒了。真正让这张图有重量的，是 EDG 在决赛打满五局后拿到世界冠军；画面里每一只手都不是一个泛用的庆祝姿势。', '把名字和年份写出来，不是为了背知识点，而是因为只有这样，才知道照片里的人到底翻过了怎样的一段路。', '胜利不是背景图；它有来处，也有具体的人。'),
    'ig-worlds': makeImageNote('assets/英雄联盟3.png', 'IG 2018：LPL 的第一座世界冠军', '黑金灯光里，IG 的队员围住召唤师杯；这是 2018 世界赛最该被叫出名字的一张画面。', 'IG 拿下的不只是一个夜晚的欢呼，而是 LPL 的第一座世界冠军。之后 FPX 在 2019 年、EDG 在 2021 年继续把这条线往下写，所以这张照片更像一段故事真正开始的地方。', '奖杯当然耀眼，但我更喜欢镜头里大家把手叠到同一个高度的瞬间：不是一张“冠军素材图”，而是一支队伍已经走到终点的证据。', '先记住谁举起了它，再去谈“冠军氛围”。'),
